    ...
    public class CryptoPricesController : ControllerBase
    {
        ...
        public async Task<List<CryptoDAO>> GetAll()
        {
            ...
            foreach (Crypto crypto in cryptos)
            {
                ...
                Root cryptoData = JsonSerializer.Deserialize<Root>(jsonString);
